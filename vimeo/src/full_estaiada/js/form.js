...
$(document).ready(function () {
    ...
    $("#form").submit(function (e) {
        ...
        let email = $('#email').val();
        // autenticar
        if (email.includes("cyrela.com.br") || email.includes("sellerassociados.com.br") || email.includes("vendascyrela.com.br")|| email.includes("bleskim.com")) {
            $.ajax({
