...
import aquarela_top_img from '../assets/imgs/aquarela-top.png'
import aquarela_right_img from '../assets/imgs/aquarela-right.png'
import header_img from '../assets/imgs/header.png'

const folder = 'living-industrial'

$( document ).ready(function() {

    const aqua_r = document.getElementById('aquarela_top');
    aqua_r.src = aquarela_top_img
