...
const project_title = "Totvs"
const folder = project_title.toLowerCase().replace(" ", "-")
...
module.exports = {
    ...
    entry: {
        ...
        perguntas: path.resolve(__dirname, `src/${folder}/js/perguntas.js`),
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            title: project_title,
            filename: 'pages/perguntas.html',
            template: `src/${folder}/pages/perguntas.html`,
            inject: true,
            chunks: [],
            minify: {
                collapseWhitespace: true
